module github.com/Nekodigi/pinyin-ocr-backend
...
require (
	...
	github.com/kercylan98/go-hanzi v1.0.0-beta // indirect
	github.com/kercylan98/go-pinyin v1.0.0-beta // indirect
	github.com/kercylan98/klib v1.0.0-beta // indirect
